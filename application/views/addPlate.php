                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder">添加板块</i></div>
                            <div class="tools">
                                ...
                                <div class="row-fluid">
                                    <div class="span6 ">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="m-wrap span8" placeholder="板块名称" id="plateName" name="plateName">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
...
//            var FileExt=file.replace(/.+\./,"");   //正则表达式获取后缀
    ...
    function add()
    {
       ...
       // alert(content);
        ...
        var addPlateURL = "/jinM/card/addPlate_do";
        $.ajax({
            type: "post",
            url: addPlateURL,
            dataType: "json",
