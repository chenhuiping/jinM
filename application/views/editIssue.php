    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                <li>
                    <i class="icon-home"></i>
                    <a href="/jinM/event/manageIssue">管理杂志</a>
                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder">修改杂志信息</i></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <h3 class="form-section">杂志信息</h3>
                            <div class="row-fluid">
                                <div class="span6 ">
                                    <div class="control-group">
                                        <label class="control-label">杂志名称</label>
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" placeholder="杂志名称" id="eventName" value="<?=$issueInfo['name']?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6"  placeholder="2015-09-01" id="eventTime" value="<?=$issueInfo['date']?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">简介</label>
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" placeholder="杂志简介" id="address" value="<?=$issueInfo['address']?>">
                                        ...
                                        <div class="controls">
                                            <form method="post" enctype="multipart/form-data" action="/jinM/event/uploadEtPhoto" id="uploadForm" name="uploadForm" >
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <input value="<?=$issueInfo['image']?>" name="imgPath" id="imgPath"  hidden="hidden"/>
                                ...
                                <div class="span6 ">
                                    <div class="control-group">
                                        <label class="control-label">杂志内容</label>
                                        <div class="controls">
                                            <script id="editor" type="text/plain" style="height:500px;"><?=$issueInfo['content']?></script>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.status==true)
                {
                    ...
                    window.location.href='/jinM/event/manageIssue';
                }
                else{
                    alert('上传失败');
                }
