                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder">Add Magazine</i></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                                ...
                                <h3 class="form-section">Magazine Info</h3>
                                <div class="row-fluid">
                                    <div class="span6 ">
                                        <div class="control-group">
                                            <label class="control-label">Magazine Name</label>
                                            <div class="controls">
                                                <input type="text" class="m-wrap span6" placeholder="Magazine Name" id="eventName">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="m-wrap span6" placeholder="Magazine Introduction" id="address">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                    ...
                                    <div class="span6 ">
                                        <div class="control-group">
                                            <label class="control-label">Magazine Content</label>
                                            <div class="controls">
...
//            var apip = $.Jcrop("#demo3");
        ...
        $('form :input').blur(function(){
            ...
            if( $(this).is('#eventName') ){
                //alert("shopName");
                if( this.value==""){
                    var errorMsg = 'Input Magazine Name.';
...
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
            ...
            if( $(this).is('#address') ){
                //alert("shopName");
                if( this.value==""){
                    var errorMsg = 'Input Magazine Introduction';
                    $parent.append('<span class="formtips onError error" style="color: #ff0000">'+errorMsg+'</span>');
                }else{
//                        var okMsg = 'Input Correct.';
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
            ...
            if( $(this).is('#eventTime') ){
                ...
                if( this.value=="" || this.value.length >12  ){
                    var errorMsg = 'Input Publishing Time.';
                    $parent.append('<span class="formtips onError error" style="color: #ff0000">'+errorMsg+'</span>');
                }else{
//                        var okMsg = 'Input Correct.';
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
...
<script type="text/javascript">
    ...
    function getContent() {
        var arr = [];
        arr.push("Use editor.getContent() function to get content from the editor");
        arr.push("Content：");
    ...
    function getPlainTxt() {
        var arr = [];
        arr.push("use editor.getPlainTxt()to get formatted plain text from the editor");
        arr.push("Content：");
