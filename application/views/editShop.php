								...
								<div class="tab-pane " id="tab_1">
									<div class="portlet box green">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder">修改店铺信息</i></div>
											<div class="tools">
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="m-wrap span12" placeholder="呷哺呷哺" id="shopName" value="<?=$shopInfo['name']?>">
															</div>
														</div>
													</div>
													<!--/span-->
													<div class="span6 ">
														<div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span12" placeholder="1368945xxxx" id="tel" value="<?=$shopInfo['tel']?>">
                                                            </div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span12" placeholder="天津市西青区" id="address" value="<?=$shopInfo['address']?>">
                                                            </div>
														</div>
													</div>
													<!--/span-->
													<div class="span6 ">
														<div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span12" placeholder="蔬菜套餐 肥牛套餐 羊肉拼盘 丸子双拼" id="intro" value="<?=$shopInfo['intro']?>">
                                                            </div>
														</div>
													</div>
													<!--/span-->
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <select name="category" id="category" class="span6" onchange="getChild()">
                                                                    <option value="">Select</option>
                                                                    <?php foreach ($categoryList as $category){ ?>
                                                                    <option value="<?=$category['id']?>"  <?php if($category['id']==$shopInfo['typeId']) echo "selected"?>><?=$category['name']?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <select name="catechild" id="catechild" class="span6">
                                                                    <?php foreach($childAll as $child){
                                                                        if($child['categoryId']==$shopInfo['typeId']){
                                                                         ?>
                                                                        <option <?php if($child['id']==$shopInfo['childId'])echo "selected='selected'";?> value="<?=$child['id'] ?>"><?=$child['name']?></option>
                                                                    <?php } } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <br/>
                                                                获取经纬度：<input id="result_"  type="text" name="result_"  value="<?=$shopInfo['location']?>" />
                                                            </div>
                                                    ...
                                                    <div class="span6 ">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <textarea class="span6 m-wrap" rows="3" name="desc" id="desc"><?=$shopInfo['desc']?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span6 ">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <textarea class="span6 m-wrap" rows="1" name="disTitle" id="disTitle"><?=$shopInfo['disTitle']?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="span6 ">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <textarea class="span6 m-wrap" rows="5" name="discount" id="discount"><?=$shopInfo['discount']?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
															...
															<div class="controls">
                                                                <form method="post" enctype="multipart/form-data" action="/jinM/shop/uploadSpPhoto" id="uploadForm" name="uploadForm" >
                                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                        ...
                                                                        <input value="<?=$shopInfo['img']?>" name="imgPath" id="imgPath" />
                                                                        <input value="<?=$shopInfo['image']?>" name="imagePath" id="imagePath"/>
                                                                    </div>
                                                                </form>
															</div>
														</div>
...
//            var FileExt=file.replace(/.+\./,"");   //正则表达式获取后缀
        ...
        $('#clear-btn').click(function(){
            api.setImage("/jinM/<?=$shopInfo['image']?>");
            document.getElementById('demo8').src="/jinM/<?=$shopInfo['image']?>";
        ...
        function edit()
        {
            ...
            var editShopURL = "/jinM/shop/editShop_do";
            $.ajax({
                type: "post",
                url: editShopURL,
                dataType: "json",
