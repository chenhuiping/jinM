    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                <li>
                    <i class="icon-home"></i>
                    <a href="/jinM/notice/allNotices">Notice of All</a>
                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder">Send Notice</i></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form id="form1">
                                <h3 class="form-section">Notice of All</h3>
                                <div class="row-fluid">
                                    <div class="span6 ">
                                        <div class="control-group">
                                            <label class="control-label">Title</label>
                                            <div class="controls">
                                                <input type="text" class="m-wrap span8" placeholder="Title" id="noticeName">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Time<span class="required">*</span></label>
                                            <div class="controls">
                                                <input type="text" class="m-wrap span8"  placeholder="2015-09-01" id="noticeTime">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn blue" onclick="add()"><i class="icon-ok"></i> Send</button>
     ...
     function push(id){
         ...
         $.ajax({
             ...
             success: function (data) {
                 ...
                 {
                     //alert('发送成功');
                     // window.location.href='/jinM/notice/manageNotice';
                 }
                 else{
                     // alert('发送失败');
                 }
        ...
        var addNoticeURL = "/jinM/notice/addNotices";
        $.ajax({
            type: "post",
            url: addNoticeURL,
            dataType: "json",
