    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                <li>
                    <i class="icon-home"></i>
                    <a href="/jinM/notice/personalNotice">个人通知</a>
                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder">发送个人通知</i></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                                ...
                                <div class="row-fluid">
                                    <div class="span6 ">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="m-wrap span8" placeholder="标题" id="noticeName">
                                            </div>
                                        </div>
                                        <div class="control-group">
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn blue" onclick="add()"><i class="icon-ok"></i> 发送</button>
...
//        alert(noticeTime);
        ...
        var addNoticeURL = "/jinM/notice/sendPersonalNotice";
        $.ajax({
            type: "post",
            url: addNoticeURL,
            dataType: "json",
            ...
            success: function (data) {
                if(data.status)
                {
                    ...
                    push(data.status);
                    alert('发送成功');
                    window.location.href='/jinM/notice/personalNotice';
                }
                else{
                    alert('发送失败');
                }
