    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                <li>
                    <i class="icon-home"></i>
                    <a href="/jinM/notice/manageNotice">全体通知</a>
                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form id="form1">
                                <h3 class="form-section">全体通知</h3>
                                <div class="row-fluid">
                                    <div class="span6 ">
                                        <div class="control-group">
                                            <label class="control-label">标题</label>
                                            <div class="controls">
                                                <input type="text" class="m-wrap span8" placeholder="" id="noticeName" value="<?=$noticeInfo['title']?>">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">时间<span class="required">*</span></label>
                                            <div class="controls">
                                                <input type="text" class="m-wrap span8"  placeholder="2015-09-01" id="noticeTime"  value="<?=$noticeInfo['date']?>">
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="span6 ">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <script id="editor" type="text/plain" style="width:1024px;height:500px;"><?=$noticeInfo['content']?></script>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
...
//        alert(noticeTime);
        ...
        var editNoticeURL = "/jinM/notice/editNotice_do";
        $.ajax({
            type: "post",
            url: editNoticeURL,
            dataType: "json",
