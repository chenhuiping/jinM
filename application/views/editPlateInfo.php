    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                <li>
                    <i class="icon-home"></i>
                    <a href="/jinM/event/manageJob">管理板块</a>
                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder">修改工作信息</i></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <h3 class="form-section">板块信息</h3>
                            <div class="row-fluid">
                                <div class="span6 ">
                                    <div class="control-group">
                                        <label class="control-label">板块名称</label>
                                        <div class="controls">
                                            <input type="text" class="m-wrap span12"  id="plateName" value="<?=$plateInfo['name']?>">
                            ...
                            <h3 class="form-section">图片设置</h3>

                            <div class="row-fluid">
                                <div class="span6 ">
                                    <div class="control-group">
                                        <?php
                                        if($plateInfo['image']!=0){
                                            ?>
                                            <div class="control-group">
                                                <label class="control-label" for="focusedInput">板块图标</label>
                                                <div class="controls">
                                                    <img src="<?=$plateInfo['plateImg']?>" />
                                                    <input type="hidden" name="photo" value="<?=$plateInfo['plateImage']?>"/>
                                                    <input type="hidden" name="photo_thu" value="<?=$plateInfo['plateImg']?>"/>
                                                </div>
                                            </div>
                                        <?php  }?>
                                        <label class="control-label">上传图片</label>
                                        <div class="controls">
                                            <form method="post" enctype="multipart/form-data" action="/jinM/card/uploadPtPhoto" id="uploadForm" name="uploadForm" >
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <input value="<?=$plateInfo['image']?>" name="imgPath" id="imgPath"  hidden="hidden"/>
...
//            var FileExt=file.replace(/.+\./,"");   //正则表达式获取后缀
    ...
    function edit()
    {
        ...
        var editPlateURL = "/jinM/card/editPlate_do";
        $.ajax({
            type: "post",
            url: editPlateURL,
            dataType: "json",
            ...
            success: function (data) {
                if(data.status==true)
                {
                    ...
                    window.location.href='/jinM/card/manageCard';
                }
                else{
                    alert('上传失败');
                }
