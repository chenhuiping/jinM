                            ...
                            <div class="row-fluid">
                                <div class="span6 ">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" placeholder="演唱会" id="eventName" value="<?=$jobInfo['name']?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6"  placeholder="2015-09-01" id="eventTime" value="<?=$jobInfo['date']?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">描述</label>
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" placeholder="天津市西青区" id="address" value="<?=$jobInfo['address']?>">
                                        ...
                                        <div class="controls">
                                            <form method="post" enctype="multipart/form-data" action="/jinM/event/uploadEtPhoto" id="uploadForm" name="uploadForm" >
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <input value="<?=$jobInfo['image']?>" name="imgPath" id="imgPath"  hidden="hidden"/>
                                ...
                                <div class="span6 ">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <script id="editor" type="text/plain" style="height:500px;"><?=$jobInfo['content']?></script>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
