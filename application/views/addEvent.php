...
<!--							<small>advance form layout samples</small>-->
                        ...
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                                <a href="/jinM/event/manage">Manage Event</a>
								...
								<div class="tab-pane " id="tab_1">
									<div class="portlet box green">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"> Add Event</i></div>
											<div class="tools">
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="m-wrap span6" placeholder="Title" id="eventName">
															</div>
														</div>
                                                        <div class="control-group">
                                                            <label class="control-label">Address</label>
                                                            <div class="controls">
                                                                <input type="text" class="m-wrap span6" placeholder="Address" id="address">
                                                            </div>
                                                        </div>
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <form method="post" enctype="multipart/form-data" action="/jinM/event/uploadEtPhoto" id="uploadForm" name="uploadForm" >
                                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                        ...
                                                                        <input type="submit" value="upload picture" name="upload-btn" id="upload-btn"/>
...
//            var apip = $.Jcrop("#demo3");
            ...
            $('form :input').blur(function(){
                ...
                if( $(this).is('#eventName') ){
                    //alert("shopName");
                    if( this.value==""){
                        var errorMsg = 'Please Insert Event Title.';
...
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
                ...
                if( $(this).is('#address') ){
                    //alert("shopName");
                    if( this.value==""){
                        var errorMsg = 'Please Insert Event Address';
                        $parent.append('<span class="formtips onError error" style="color: #ff0000">'+errorMsg+'</span>');
                    }else{
//                        var okMsg = 'OK.';
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
                ...
                if( $(this).is('#eventTime') ){
                    ...
                    if( this.value=="" || this.value.length >12  ){
                        var errorMsg = 'Please Insert Event Time.';
                        $parent.append('<span class="formtips onError error" style="color: #ff0000">'+errorMsg+'</span>');
                    }else{
//                        var okMsg = 'OK.';
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
                ...
                if( $(this).is('#category') ){
                    //alert("shopName");
                    if( this.value=="" ){
                        var errorMsg = 'Please Select Category.';
                        $parent.append('<span class="formtips onError error" style="color: #ff0000">'+errorMsg+'</span>');
                    }else{
//                        var okMsg = 'OK.';
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
