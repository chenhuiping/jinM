								...
								<div class="tab-pane " id="tab_1">
									<div class="portlet box green">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder">添加店铺分类</i></div>
											<div class="tools">
										...
										<div class="portlet-body form">
                                            ...
                                            <form id="form1">
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group" id="categoryName-cg">
															<label class="control-label ">分类名称 <span style="color:#ff0000">*</span></label>
															<div class="controls">
																<input type="text" class="m-wrap span12" placeholder="Dining" id="categoryName" >
															</div>
														</div>
													</div>
												</div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span6 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" placeholder="中餐" class="m-wrap medium" name="childName" >
                                                        </div>
...
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
                ...
                if( $(this).is("[name='childName']") ){
//                    alert("childName");
                    if( this.value==""){
                        var errorMsg = '请输入子类名称.';
                        $parent.append('<span class="formtips onError error">'+errorMsg+'</span>');
                    }else{
//                        var okMsg = '输入正确.';
//                        $parent.append('<span class="formtips onSuccess">'+okMsg+'</span>');
...
//            var FileExt=file.replace(/.+\./,"");   //正则表达式获取后缀
        ...
        function add()
        {
            ...
            {
                var addCategoryURL = "/jinM/shop/addCategory_do";
                $.ajax({
                    type: "post",
                    url: addCategoryURL,
                    ...
                    success: function (data) {
                        if(data.status==true)
                        {
                            ...
                            {
                                addChild(child[i].value,data.pid);
                            }
...
//        });
        ...
        $("#addInput").click(function(){
            ...
            str = str + "<input type='text' placeholder='中餐' class='m-wrap medium' name='childName'>";
            str = str + "</div>";
